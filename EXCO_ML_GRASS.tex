...
Thus, the algorithm of GaussianNB Classifier computes the likelihood of the features using the Bayes' theorem which assumes the independence between every pair of pixels on a raster image according to Gaussian distribution and considers the value of cells assigned to each class as variables. 
...
The cartographic visualization of the images processed with four methods is presented in Figure \ref{fig03}.
