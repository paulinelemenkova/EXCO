...
machine learning \sep cartography \sep mapping \sep satellite image \sep image processing \sep programming \sep scripting language \sep automation \sep Earth observation \sep geospatial analysis
...
\subsection{Data}
The algorithms of GRASS GIS were tested on the RS data presented by the Landsat-8 OLI-TIRS image covering western segment of the Nile Delta and the Faiyum Oasis, upper Egypt, Figure \ref{fig01}. 
...
\begin{figure}[H]
  ...
  \begin{tabular}[b]{c}
    ...
    \small (d)
  \end{tabular}
  \caption{Data source: Landsat-8 OLI/TIRS satellite image covering western segment of the Nile Delta and the 
Faiyum Oasis, Egypt, with the examples of the colour composites. The image was created in GRASS GIS using triplets of the bands by employed 'r.composite' module: \textbf{(a)}: Original image in RGB; \textbf{(b)}: Bands 2-3-4; \textbf{(c)}: Bands 3-4-5; \textbf{(d)}: Bands 7-5-4.}
  \label{fig01}
\end{figure}

Technical characteristics of the Landsat-8 OLI/TIRS satellite image are as follows: Product Identifier L2: LC08\_L2SP\_177039\_20231126\_20231129\_02\_T1; L1: LC08\_L1TP\_177039\_20231126\_20231129\_02\_T1. The Landsat Scene Identifier is LC81770392023330LGN00. The data are provided by the USGS as open resource. The image was collected on 26 November 2023 with major metadata summarised in Table \ref{tab01}.

%\begin{table}[!ht]
\begin{table}[H]
\caption {Metadata of the satellite image Landsat-8 OLI/TIRS}
    \begin{center}
    \tiny
    \begin{tabular}{|l|l|l|l|}
    \hline
        	\textbf{Data Set Attribute} & \textbf{Attribute Value} & \textbf{Data Set Attribute} & \textbf{Attribute Value} \\ \hline
        Collection Category & T1 & Sensor Identifier & OLI\_TIRS \\ \hline
        Collection Number & 2 & Satellite & 8 \\ \hline
        WRS Path & 177 & Product Map Projection L1 & UTM \\ \hline
        WRS Row & 39 & UTM Zone & 36 \\ \hline
        Target WRS Path & 177 & Datum & WGS84 \\ \hline
        Target WRS Row & 39 & Ellipsoid & WGS84 \\ \hline
        Nadir/Off Nadir & NADIR & Scene Center Lat DMS & "30°18'22.28""N" \\ \hline
        ...
        Data Type L2 & OLI\_TIRS\_L2SP & Corner Lower Right Longitude & 31.60246 \\ \hline
