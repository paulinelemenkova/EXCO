...
\hl{The satellite} images \hl{(Figure} \ref{fig02}) were selected based on their quality, coverage and suitability, and downloaded from the EarthExplorer website: \href{https://earthexplorer.usgs.gov/}{\hl{https://earthexplorer.usgs.gov/}}. 
